	...
	order-l-red-i border-t-red-iii border-r-red-iii border-red-i shadow-md absolute self-center  '>
				<div className='flex flex-col rounded-3xl'>
					<header className='z-10 flex-row-reverse items-center justify-around hidden xl:flex rounded-3xl'>
						...
						<h1 className='px-10 py-4 mx-2 text-center border-2 xl:text-4xl bg-red-ii rounded-3xl border-clr-iiiii text-clr-iiiii'>
							Poke
					...
					<div className='hidden w-full h-20 mt-10 mb-4 overflow-hidden border-2 shadow-md xl:flex bg-clr-iiiiii rounded-xl border-clr-ii '>
				...
				<article className='flex-col justify-around hidden w-full px-8 py-5 bg-gray-100 rounded xl:flex drop-shadow-md h-3/5'>
					<div className='flex flex-col w-full h-full pt-10 mb-4 overflow-scroll text-lg bg-white border-2 rounded shadow justify-evenly'>
