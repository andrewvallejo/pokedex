export const FakeController = () => {
	...
	order-l-red-i border-t-red-iii border-r-red-iii border-red-i shadow-md absolute self-center  overflow-hidden'>
				<div className='flex flex-col rounded-3xl'>
					<header className='z-10 flex-row-reverse items-center justify-around hidden mt-4 md:flex rounded-3xl'>
						<div className='flex flex-col-reverse flex-wrap md:flex-row'>
							<h1 className='px-10 py-4 my-10 mb-10 text-center border-2 l:ml-10 md:text-4xl bg-red-ii rounded-3xl border-clr-iiiii text-clr-iiiii'>
								Poke
